...
Exp.addParams.trial_prepro_dir = '../../stimuli_trimmed/RandFace_preprocessed_trials/';
...
if exist([Exp.addParams.trial_prepro_dir Gral.subjNo '/' ...
    ...
    if create_trials == 'y' || create_trials == 'Y'
        leave_text = sprintf('\nPassing control to RSVP_RandFace_create_trials, retry when complete\n');
        disp(leave_text)
        RSVP_RandFace_create_trials;
        graceful_finish = 1;
    else
        graceful_finish = 1;
    end
